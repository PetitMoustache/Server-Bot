...
async function mute(interaction) {
    ...
    try {
        ...
        await sendToMailbox(interaction.guild, target.user, 'Moderation', `🔇 **You have been muted.**\n**Duration:** ${durationStr}\n**Reason:** ${reason}\n**Moderator:** ${interaction.user.tag}`, 'Red', interaction.user.id, 'Mute Notice 🔇');
...
async function unmute(interaction) {
    ...
    try {
        ...
        await sendToMailbox(interaction.guild, target.user, 'Moderation', `🔊 **You have been unmuted.**\n**Reason:** ${reason}\n**Moderator:** ${interaction.user.tag}`, 'Green', interaction.user.id, 'Unmute Notice 🔊');

        mutesDb.removeMute(target.id, interaction.guild.id);
